    ...
    return(
        ...
        <header className=" bg-pink-900">
            <div className="max-w-screen-2xl mx-auto h-[40rem] flex flex-col md:flex md:flex-row">
                ...
                <h3 className="text-pink-200 font-serif font-bold text-lg">Hello!</h3>
                <h1 className="text-black font-serif font-extrabold text-3xl md:text-5xl lg:text-7xl">{`I'm Amraha Anwar`}</h1>
                    <p className="text-black text-lg font-bold font-serif md:text-2xl mb-6">A Front-End Developer.</p>
                    <p className="text-pink-200 text-sm md:text-lg lg:mt-11"> {`I'm here to make the digital world a little more beautiful and functional.`} </p>
                    <p className="text-pink-200 text-sm md:text-lg mt-4">{`Let's turn your ideas into digital reality!`}</p>
                </div>
                ...
                <div className="hidden lg:block mt-20 mr-5 xl:mt-10 xl:mr-10">
                        <Image className="rounded-full" src="/images/profile.png" alt="profile picture" width={500} height={520}/>
                </div>
