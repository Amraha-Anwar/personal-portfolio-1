...
function About(){
    return(
        <>
        <main className="max-w-screen-2xl mx-auto bg-pink-50 h-[35rem] md:h-[40rem] lg:h-[45rem]">
            <div className="sm:hidden pt-16 mx-10 ">
            <div className="container rounded-full w-[17rem] h-[28rem] border border-black shadow-lg shadow-teal-700 bg-white ">
                <h1 className=" text-center text-2xl font-bold pt-12 font-serif"><u className="underline-offset-8 text-teal-900">ABOUT ME</u></h1> 
            ...
            <div className="container rounded-full lg:rounded-lg w-[18rem] h-[28rem] md:w-[22rem] md:h-[32rem] lg:w-[25rem] lg:h-[35rem]  xl:w-[40rem] border border-black shadow-lg shadow-teal-700 bg-white ">
                <h1 className=" text-center text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold pt-12 lg:pt-14 font-serif"><u className="underline-offset-8 text-teal-900">ABOUT ME</u></h1> 
